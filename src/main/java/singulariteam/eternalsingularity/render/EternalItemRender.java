 ...
 */
public class EternalItemRender extends CosmicItemRender {

	private Random randy = new Random();

	public EternalItemRender(IModelState state, IBakedModel model) {
		super(state, model);
	}

	public EternalItemRender(IModelState state, IWrappedModelGetter getter) {
		super(state, getter);
	}
	...
	public void renderItem(ItemStack stack, TransformType transformType) {
		...
		super.renderItem(stack, transformType);
	}
}
